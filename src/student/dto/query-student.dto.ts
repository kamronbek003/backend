...
export class QueryStudentDto {
  ...
  @Max(1000, { message: "Elementlar soni 100 dan ko'p bo'lmasligi kerak." })
  limit?: number = 10;
  ...
  @ApiPropertyOptional({
    description: "Talaba IDsi bo'yicha filtr (qisman moslik, registrsiz)",
    type: String,
    example: 'N100',
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: "Ism yoki familiya bo'yicha filtr (qisman moslik, registrsiz)",
    type: String,
  })
  @IsOptional()
  @IsString()
  ...
  @ApiPropertyOptional({
    description: "Telefon raqami bo'yicha filtr (qisman moslik)",
    type: String,
  })
  @IsOptional()
  @IsString()
  ...
  @ApiPropertyOptional({
    description: "Guruh IDsi bo'yicha filtr (talaba shu guruhga a'zo bo'lishi kerak)",
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: "Talaba statusi bo'yicha filtr",
    enum: Status,
  })
  @IsOptional()
  @IsEnum(Status, {
    message: "Status qiymati noto'g'ri (FAOL, NOFAOL, TUGATGAN).",
  })
  filterByStatus?: Status;

  @ApiPropertyOptional({
    description: "Talaba bali bo'yicha filtr (aniq moslik)",
    type: Number,
  })
  @IsOptional()
  @Type(() => Number)
  ...
  @ApiPropertyOptional({
    description: "Aksiyadagi talabalar bo'yicha filtr",
    type: Boolean,
    example: true,
  })
  @IsOptional()
  @Type(() => Boolean)
  @IsBoolean({
    message: "Aksiya filteri boolean (haqiqiy/yolg'on) qiymat bo'lishi kerak.",
  })
  filterByPromotion?: boolean;
}